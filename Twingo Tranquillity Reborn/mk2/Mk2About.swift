                ...
                TabView{
                    VStack{
                            ...
                            ScrollView(.horizontal, showsIndicators: false, content:{
                                HStack{
                                    ...
                                    Image("mk2img")
                                        ...
                                        .frame(width: geometry.size.width*0.94, height: geometry.size.height*0.45)
                                    Spacer()
                                ...
                                HStack{
                                    ZStack{
                                        RoundedRectangle(cornerRadius:23)
                                            ...
                                            .frame(width: geometry.size.width*0.965, height: geometry.size.height*0.25)
                                            .shadow(radius: 10)
                                            .padding(5)
                                        Text("""
                        ...
                        """)
                            ...
                            .frame(width: geometry.size.width*0.99, height: geometry.size.height*0.25)
                        ...
                        """)
                            ...
                            .frame(width: geometry.size.width*0.99, height: geometry.size.height*0.30)
                        })
